...
IpInputGroup::IpInputGroup(QWidget *parent) : QWidget(parent)
{
...
IpInputGroup::~IpInputGroup()
{

}

QString IpInputGroup::GetIp() const
{
    return m_qIp;
}

QColor IpInputGroup::GetBackGroundColor() const
{
    return m_qBackGroundColor;
}

QColor IpInputGroup::GetBorderColor() const
{
    return m_qBorderColor;
}

QColor IpInputGroup::GetTextColor() const
{
    return m_qTextColor;
}

int IpInputGroup::GetBorderRadius() const
{
    return m_nBorderRadius;
}

QFont IpInputGroup::GetTextFont() const
{
    return m_qFont;
}


void IpInputGroup::SetIp(const QString &ip)
{
...
void IpInputGroup::SetBackGroundColor(const QColor &backgroundcolor)
{
...
void IpInputGroup::SetBorderColor(const QColor &bordercolor)
{
...
void IpInputGroup::SetBorderRadius(const int &borderradius)
{
...
void IpInputGroup::SetTextColor(const QColor &textPalette)
{
...
void IpInputGroup::SetTextFont(const QFont &textfont)
{
    if(m_qFont != textfont)
    {
...
bool IpInputGroup::eventFilter(QObject *watched, QEvent *event)
{
...
void IpInputGroup::SetStyleSheet()
{
...
void IpInputGroup::textChanged(const QString &text)
{
    int len = text.length();
